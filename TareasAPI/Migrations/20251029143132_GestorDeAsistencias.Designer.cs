...
namespace TareasAPI.Migrations
{
    ...
    [Migration("20251029143132_GestorDeAsistencias")]
    partial class GestorDeAsistencias
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TareasApi.Models.Asistencia", b =>
                {
                    ...
                    b.HasIndex("GrupoId", "Fecha")
                        .HasDatabaseName("IX_Asistencias_GrupoId_Fecha");
            ...
            modelBuilder.Entity("TareasApi.Models.Entrega", b =>
                {
                    ...
                    b.Property<string>("RetroalimentacionProfesor")
                        .HasMaxLength(1000)
            ...
            modelBuilder.Entity("TareasApi.Models.Entrega", b =>
                {
                    ...
                    b.HasOne("TareasApi.Models.Usuario", "Profesor")
                        .WithMany()
